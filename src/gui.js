...
IDE_Morph.prototype.createSpriteBar = function () {
  ...
  function addRotationStyleButton(rotationStyle) {
    ...
    button.setTop(
      button.top() + (rotationStyleButtons.length - 1) * (button.height() + 2)
    );
...
IDE_Morph.prototype.fixLayout = function (situation) {
  ...
  if (situation !== "refreshPalette") {
    ...
    if (this.spriteEditor.isVisible) {
      this.spriteEditor.setPosition(
        new Point(this.spriteBar.left(), this.spriteBar.bottom() + padding)
      );
      this.spriteEditor.setExtent(
        new Point(
...
IDE_Morph.prototype.setExtent = function (point) {
  ...
  if (this.isAppMode) {
    if (this.isEmbedMode) {
      ...
      minExt = this.stage.dimensions.add(this.controlBar.height() + 10);
    }
  } else {
  ...
  maxWidth = ext.x - (200 + this.spriteBar.tabBar.width() + this.padding * 2);
...
IDE_Morph.prototype.render = function (ctx) {
  ...
  if (this.isAppMode && this.stage) {
    ...
    ctx.strokeStyle = (
      MorphicPreferences.isFlat ? this.backgroundColor : this.groupColor
    ).toString();
    ctx.lineWidth = 1;
    ctx.beginPath();
    ...
    this.getURL(
      ...
      (blob) => {
        ...
        reader.onloadend = () => {
          ...
          base64 = "data:audio/ogg;base64," + base64.split(",")[1];
          anAudio.src = base64;
...
IDE_Morph.prototype.newCamSprite = function () {
  ...
  camDialog = new CamSnapshotDialogMorph(
    ...
    () => this.removeSprite(sprite),
    function (costume) {
      // needs to be "function" to it can access "this"
...
IDE_Morph.prototype.snapMenu = function () {
  ...
  menu.addItem("Download source", () =>
    window.open("https://github.com/jmoenig/Snap/releases/latest", "SnapSource")
  );
  if (world.isDevMode) {
    menu.addLine();
    menu.addItem(
...
IDE_Morph.prototype.settingsMenu = function () {
  ...
  menu.addPair(
    [
      new SymbolMorph("globe", MorphicPreferences.menuFontSize),
      localize("Language..."),
    ],
    "languageMenu"
  );
...
IDE_Morph.prototype.switchToScene = function (
  ...
  this.siblings().forEach((morph) => morph.destroy());
  this.scene.captureGlobalSettings();
  this.scene = scene;
...
LibraryImportDialogMorph.prototype.fixLayout = function () {
  ...
  if (this.body) {
    ...
    this.listField.setExtent(new Point(200, this.body.height()));
...
SpriteIconMorph.prototype.flash = function () {
  ...
  world.animations.push(
    new Animation(nop, nop, 0, 800, nop, () => {
      if (isFlat) {

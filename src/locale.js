...
Localizer.prototype.translate = function (string) {
  ...
  return Object.prototype.hasOwnProperty.call(this.dict[this.language], phrase)
    ? this.dict[this.language][phrase]
    : phrase;
};
...
SnapTranslator.dict.de = {
  ...
  last_changed: "2022-04-28",
};

SnapTranslator.dict.it = {
  language_name: "Italiano",
  language_translator: "Stefano Federici, Alberto Firpo, Massimo Ghisalberti",
  "translator_e-mail":
    "s_federici@yahoo.com, albertofirpo12@gmail.com, zairik@gmail.com",
  last_changed: "2022-91-03",
};
...
SnapTranslator.dict.el = {
  ...
  last_changed: "2020-11-23",
};

SnapTranslator.dict.ca = {
  language_name: "Català",
  language_translator: "Bernat Romagosa Carrasquer, Joan Guillén i Pelegay",
  "translator_e-mail": "bernat@snap4arduino.rocks, jguille2@xtec.cat",
  last_changed: "2022-01-05",
};
...
SnapTranslator.dict.pt_BR = {
  ...
  language_translator: "Aldo von Wangenheim, Cassiano D'Andrea",
...
SnapTranslator.dict.te = {
  language_name: "Telagu", // the name as it should appear in the language menu
  language_translator: "vinayakumar R", // your name for the Translators tab
  "translator_e-mail": "vnkmr7620@gmail.com", // optional
  last_changed: "2015-02-20",
};
...
SnapTranslator.dict.tr = {
  ...
  "translator_e-mail": "tguneysu@msn.com", // hakanatas@gmail.com, mustafaipekbayrak@gmail.com',
...
SnapTranslator.dict.bg = {
  ...
  language_translator: "Ivan Savov",
...
SnapTranslator.dict.ar = {
  language_name: "العربية", // the name as it should appear in the language menu
  language_translator: "طارق جلال", // your name for the Translators tab
  "translator_e-mail": "tarekgalal46@hotmail.com", // optional
  last_changed: "2016-02-24",
};
...
SnapTranslator.dict.et = {
  ...
  last_changed: "2016-05-03",
};

SnapTranslator.dict.gl = {
  language_name: "Galego",
  language_translator: "tecnoloxia <2016>,Miguel A. Bouzada <2019>",
  "translator_e-mail": "mbouzada@gmail.com",
  last_changed: "2019-07-29",
};
